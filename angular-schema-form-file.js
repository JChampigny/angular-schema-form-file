                   ...
                   if (file && !file.$error && scope.url) {
                       ...
                       file.upload.then(function (response) {
                           ...
                           if (response.status > 0) {
                               scope.errorMsg = (response.data.hasOwnProperty("message")) ? response.data.message : response.data;
                               ngModel.$setValidity('tv4-500', false);
                           }
                       });
               ...
               if (ngModel) {
                   scope.validateField = function () {
                       if (scope.uploadForm.file && scope.uploadForm.file.$valid && scope.picFile && !scope.picFile.$error) {
                           ...
                           console.log('single-form and multifile-form are valid');
                       }
                       validateRequired();
                   };
